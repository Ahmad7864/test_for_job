...
<head>
    ...
    <link href="<?php echo base_url();?>assets_admin/css/oz_style_custome.css" rel="stylesheet">
    <!-- jQuery -->
                ...
                <section class="login_content">
                    <form name="login" id="login" method="post" action="<?php echo site_url('user/login');?>" novalidate>
                        ...
                        <div class="separator">
                            ...
                            <img width="100%" class="logo_img" src="/assets/Sukut_Real_Pro_LOGO.jpg" style="margin-top: 40px; margin-bottom: 20px;max-width: 200px;">
                            <p style="color: white">©2021 All Rights Reserved
                                <?php echo $site_title;?>
                            </p>
                    </form>
                </section>
