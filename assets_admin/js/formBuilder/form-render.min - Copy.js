        ...
        var m = function() {
            function t() {
                ...
                var n = {
                    ...
                    dataType: "json",
                    formData: !1,
                    i18n: Object.assign({}, p.defaultI18n),
                    messages: {
                ...
                if (this.options = jQuery.extend(!0, n, e), this.instanceContainers = [], a.default.current || a.default.init(this.options.i18n), !this.options.formData) return !1;
                this.options.formData = this.parseFormData(this.options.formData), f.default.controlConfig = e.controlConfig || {}, f.default.loadCustom(e.controls), Object.keys(this.options.templates).length && d.default.register(this.options.templates), "function" != typeof Element.prototype.appendFormFields && (Element.prototype.appendFormFields = function(e) {
                    Array.isArray(e) || (e = [e]);
                    var t = l.default.markup("div", e, {
                        className: "rendered-form"
                    });
                    this.appendChild(t), e.forEach(function(e) {
                        t.appendChild(e), e.dispatchEvent(u.default.fieldRendered)
                    })
            ...
            return t.prototype.santizeField = function(e, t) {
                ...
                return t && (n.id = e.id && e.id + "-" + t, n.name = e.name && e.name + "-" + t), n.className = Array.isArray(e.className) ? l.default.unique(e.className.join(" ").split(" ")).join(" ") : e.className || e.class || null, delete n.class, e.values && (e.values = e.values.map(function(e) {
                    return l.default.trimObj(e)
                })), l.default.trimObj(n)
                ...
                if (n.formData) {
                    for (var o = new n.layout(n.layoutTemplates), i = 0; i < n.formData.length; i++) {
                        var a = n.formData[i],
                            ...
                            u = f.default.getClass(a.type, a.subtype),
                            c = o.build(u, s);
                        r.push(c)
                    }
                    ...
                    var d = l.default.markup("div", n.messages.noFormData, {
                        className: "no-form-data"
                    });
                    r.push(d), n.notify.error(n.messages.noFormData)
                }
                return this
                ...
                var r = this.santizeField(n),
                    o = new t.layout,
                    i = f.default.getClass(n.type, n.subtype),
            ...
            var t = void 0,
                n = {
                    init: function(e) {
                        ...
                        return t = e, n.instance = new m(r), e.each(function(t) {
